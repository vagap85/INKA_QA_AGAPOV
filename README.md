...
· java/com/company/pages/ - Page Object Model: <br>
  ...
  · components/ - компоненты страниц:
    · AddUserModal.java - модальное окно добавления пользователя
    · EditUserModal.java - модальное окно редактирования
    · SaveChangesModal.java - модальное окно сохранения изменений
· java/com/company/tests/ - Тестовые классы:
  · base/ - базовые классы:
    · BaseTest.java - базовый тестовый класс с настройками
  · functional/ - функциональные тесты:
    · UserCreationTest.java - тесты создания пользователей
    · UserEditTest.java - тесты редактирования
    · UserTableTest.java - тесты таблицы пользователей
  · validation/ - тесты валидации:
    · UserValidationTest.java - проверка валидации полей
· java/com/company/data/ - Тестовые данные:
  · TestData.java - класс с тестовыми данными
· resources/ - Ресурсы:
  · config/ - конфигурационные файлы:
    · config.properties - настройки окружения
  · test-data/ - данные для тестов:
    · users.json - JSON с тестовыми пользователями
